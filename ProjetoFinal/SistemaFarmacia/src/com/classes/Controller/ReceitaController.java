...
public class ReceitaController {
    ...
    public void cadastrar(Scanner sc) {
        try {
            ...
            System.out.println("\n--- CADASTRO RECEITA ---");
            System.out.print("Nome do paciente: "); r.setNomePaciente(sc.nextLine());
            System.out.print("CPF do paciente: "); r.setCpfPaciente(sc.nextLine());
            System.out.print("Nome do médico: "); r.setNomeMedico(sc.nextLine());
            System.out.print("CRM do médico: "); r.setCrmMedico(sc.nextLine());
            System.out.print("ID do remédio autorizado: "); r.setIdRemedio(Integer.parseInt(sc.nextLine()));
            System.out.print("Data de emissão (yyyy-MM-dd): "); r.setDataEmissao(fmt.parse(sc.nextLine()));
            System.out.print("Validade em dias: "); r.setValidadeDias(Integer.parseInt(sc.nextLine()));
            System.out.print("Observações: "); r.setObservacoes(sc.nextLine());
    ...
    public void buscarPorCpf(Scanner sc) {
